...
<div id="container">
    ...
    <noscript>
        <div class="nojs">Sorry, this wizard needs JavaScript to do its magic. It will not work with your current
            setup.
        </div>
    </noscript>
    ...
    <form action="index.php" method="post" id="ajax__plugin_wiz">
        ...
        <div id="plugin_info">
            ...
            <input type="text" name="plugin[author][name]" value="" class="edit validate_string"
                   id="plugin_author_name">
            <br/>

            <label for="plugin_author_mail" class="block">E-Mail:</label>
            <input type="text" name="plugin[author][mail]" value="" class="edit validate_string"
                   id="plugin_author_mail">
            <br/>
            ...
            <input type="text" name="plugin[date]" value="<?php echo strftime('%Y-%m-%d', time()) ?>"
                   class="edit validate_date" id="plugin_date"/>
            <br/>
